/*
*  file name : DrvCodec_WM8994.h
**
*  author : Samsung S/W Platform 1 Group
*  object : Audio Device API
...
/* ===========================================================================
**		CODEC Input & Output Port Definition
** =========================================================================*/
...
typedef enum {
  INPUT_NONE,
  ANALOG_IN1L,	// Main MIC		
  ANALOG_IN1R,	// Ear MIC
  ANALOG_IN2N,	// FM Radio	
  ANALOG_IN2P,	// Reference MIC
  INPUT_BT
} wm8994_analog_input;
...
typedef enum {
  ...
  BOTHOUT,
  OUTPUT_BT
} wm8994_analog_output;

typedef enum {
  PCM_DATA,
  I2S_DATA
} wm8994_digital_datatype;
...
typedef enum {
  ...
  WM_LINEOUT2,
  WM_HPOUT1_SPKOUTL
} wm8994_analog_output_ex;

typedef enum {
  DIGITAL_AIF_NONE, // Analog bypass
  DIGITAL_AIF1,
  DIGITAL_AIF2,
  DIGITAL_AIF_BOTH_MIX,
  DIGITAL_AIF_BOTH_SWITCH
} wm8994_digital_aif;



/* For WM8994 Gain Tuning */
// Normal Playback 
#define TUNE_PLAYBACK_SPK_VOL				0x3F	// 0x26, 0x27
#define TUNE_PLAYBACK_SPK_CLASSD			0x2		// 0x25

#define TUNE_PLAYBACK_HP_VOL				0x39	// 0x1C, 0x1D
#define TUNE_PLAYBACK_HP_VOL_DATACALL	0x3B	// 0x1C, 0x1D

#define TUNE_PLAYBACK_NOTI_SPK_VOL		0x3F	// 0x26, 0x27
#define TUNE_PLAYBACK_NOTI_SPK_CLASSD	0x2		// 0x25
#define TUNE_PLAYBACK_NOTI_HP_VOL		0x2A	// 0x1C, 0x1D

#define TUNE_PLAYBACK_RING_SPK_VOL		0x3F	// 0x26, 0x27
#define TUNE_PLAYBACK_RING_SPK_CLASSD	0x2		// 0x25
#define TUNE_PLAYBACK_RING_HP_VOL		0x22	// 0x1C, 0x1D

// Voice Memo 
#define TUNE_MEMO_MAIN_MIC_VOL			0x1F	// 0x18

#define TUNE_MEMO_EAR_MIC_VOL			0x1F	// 0x1A

//Voice Call
#define TUNE_CALL_RCV_MAIN_MIC_VOL		0x0B	// 0x18
#define TUNE_CALL_RCV_RCV_VOL				0x39	// 0x20, 0x21

#define TUNE_CALL_SPK_SUB_MIC_VOL			0x0E	// 0x18
#define TUNE_CALL_SPK_SPK_VOL				0x3C	// 0x26, 0x27
#define TUNE_CALL_SPK_SPK_CLASSD			0x2		// 0x25

#define TUNE_CALL_HP_EAR_MIC_VOL			0x0D	// 0x1A
#define TUNE_CALL_HP_HP_VOL				0x33	// 0x1C, 0x1D

// FM Radio
#if 0
#define TUNE_FM_SPK_IN_VOL					0x14	// 0x19, 0x1B
#define TUNE_FM_SPK_VOL					0x3F	// 0x26, 0x27
#define TUNE_FM_SPK_CLASSD				0x2		// 0x25
#else
#define TUNE_FM_SPK_IN_VOL					0x11	// 0x19, 0x1B
#define TUNE_FM_SPK_VOL					0x3E	// 0x26, 0x27
#define TUNE_FM_SPK_CLASSD				0x0		// 0x25
#endif
#define TUNE_FM_HP_IN_VOL					0x0F	// 0x19, 0x1B
#define TUNE_FM_HP_VOL						0x3F	// 0x1C, 0x1D

#define TUNE_FM_SPK_HP_IN_VOL				0x0F	// 0x19, 0x1B
#define TUNE_FM_SPK_HP_HP_VOL				0x23	// 0x1C, 0x1D
#define TUNE_FM_SPK_HP_SPK_VOL			0x3F	// 0x26, 0x27
#define TUNE_FM_SPK_HP_CLASSD				0x2		// 0x25

#define DC_SERVO_OFFSET	4

/********** For GT-I5800 Gain Tuning *************/
#define TUNE_PLAYBACK_SPK_VOL_OPEN		0x3E	// 0x26, 0x27

#define TUNE_PLAYBACK_NOTI_SPK_VOL_OPEN	0x3E	// 0x26, 0x27

#define TUNE_PLAYBACK_RING_SPK_VOL_OPEN	0x3E	// 0x26, 0x27

//Voice Call
#define TUNE_CALL_SPK_SPK_VOL_OPEN		0x3A	// 0x26, 0x27

// FM Radio
#define TUNE_FM_SPK_VOL_OPEN				0x3E	// 0x26, 0x27
#define TUNE_FM_SPK_HP_SPK_VOL_OPEN		0x3F	// 0x26, 0x27


extern u16 new_fm_hp_vol;
...
/* Codec Input Path */
#define MM_AUDIO_IN_MAIN     0x01
#define MM_AUDIO_IN_SUB      0x02
#define MM_AUDIO_IN_EAR      0x03
#define MM_AUDIO_IN_BT       0x04
/* Playback Path */
